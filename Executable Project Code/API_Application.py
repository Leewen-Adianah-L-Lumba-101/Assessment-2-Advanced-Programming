...
def mainMenu():
    ...
    my_image = customtkinter.CTkImage(light_image=Image.open("The Movie Database Logo.png"),
...
RELEASES""", font = buttonstyle, command = lambda: findChoice(choice = "NewReleases", widget = combobox))
    ...
    shortlogo = customtkinter.CTkImage(light_image=Image.open("The Movie Database Logo (SHORT).png"),
